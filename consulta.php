...
<div id="form-cad">
    ...
    <form action="">
        <input name="busca" value="<?php if(isset($_GET['busca'])) echo $_GET['busca']; ?>" placeholder="Digite o CNS ou Id da consulta" type="text">
    ...
    <table>
        ...
        if (!isset($_GET['busca'])) {
            ...
            $sql_code = "SELECT
                ...
                where idconsulta like '$pesquisa' or c.cns like '$pesquisa'";
